...
public class FcmService {
  ...
  public void sendNewReservationMessageToDriver(
      String busDriverToken, Member member, Long reservationId, Long busId, int startSeq, int endSeq) throws IOException {

    String message = makeNewReservationMessage(busDriverToken, member, reservationId, busId, startSeq, endSeq);
  ...
  private String makeNewReservationMessage(String targetToken, Member member, Long reservationId, Long busId, int startSeq, int endSeq) throws JsonProcessingException {
    ...
    NewReservationMessage newReservationMessage = NewReservationMessage.builder()
        .message(NewReservationMessage.Message.builder()
            ...
            .data(NewReservationMessage.Data.builder()
                ...
                .aTime(LocalDateTime.now())
                .mId(member.getId())
                .mName(member.getUsername())
                .mSex(member.getSex())
                .mBirthDate(String.valueOf(member.getBirthDate()))
                .mNum(member.getPhoneNumber())
                .rId(String.valueOf(reservationId))
