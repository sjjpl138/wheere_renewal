...
class BusCurrentInfoView extends StatefulWidget {
  ...
  const BusCurrentInfoView({Key? key, required this.busCurrentInfoViewModel}) : super(key: key);
...
class _BusCurrentInfoViewState extends State<BusCurrentInfoView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar.build(context, title: "예약정보", leading: const BackIconButton()),
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              BusCurrentInfo(busStationInfoList: _busCurrentInfoViewModel.busStationInfoList),
